...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/95 text-card-foreground flex flex-col gap-5 rounded-xl border border-border/80 py-5 shadow-[0_1px_2px_rgba(20,27,50,0.035),0_8px_24px_rgba(20,27,50,0.025)] transition-[border-color,box-shadow,transform,background-color] duration-300 ease-out",
        className
      )}
      {...props}
    />
